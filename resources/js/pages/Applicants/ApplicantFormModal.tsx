        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg w-full max-w-2xl p-6 relative">
                ...
                <form onSubmit={submit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div><label className="block text-sm font-medium text-gray-700 mb-1">Experience</label><input value={data.experience || ''} onChange={e => setField('experience', e.target.value)} placeholder='e.g. 2.5 Years, 2 Years or 0.6 Years' className="w-full px-3 py-2 border rounded" /></div>
                    <div>
